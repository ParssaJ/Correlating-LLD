...
if __name__ == '__main__':
    ...
    top_level_domains = [("Agriculture, Forestry, Fishing & Hunting", "0", "21"),
                         ("Mining", "21", "22"),
                         ("Utilities", "22", "23"),
                         ("Construction", "23", "31"),
                         ("Manufacturing", "31", "41"),
    ...
    keywords_to_delete_from_column = [("Real Estate & Rental & Leasing", "electronics"),
    ...
    # This line was taken from: https://stackoverflow.com/questions/56329472/python-pandas-column-sort-by-count
